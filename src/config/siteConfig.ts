...
export const siteConfig: SiteConfig = {
	title: "一只捡星星的熊",
	subtitle: "个人技术博客",
	siteURL: "https://niushaoxiong.top/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-09-08", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "94179543394_bili", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
